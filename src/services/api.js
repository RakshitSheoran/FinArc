...
export const api = {
  ...
  editTransaction: (id, body) => request(`/api/transactions/${id}`, { method: "PUT", body: JSON.stringify(body) }),
  deleteTransaction: (id) => request(`/api/transactions/${id}`, { method: "DELETE" }),

  // Goals
  getGoal: () => request("/api/goals"),
  updateGoal: (amount) => request("/api/goals", { method: "PUT", body: JSON.stringify({ amount }) }),
};
